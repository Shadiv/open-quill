...
2. **Pass style context**: Ensure @cowriter reads `openquill/style_profile.md` before drafting. If missing, call @stylematcher first to build it.
3. **Pass canon context**: Ensure @cowriter reads relevant canon files — `openquill/characters.md` for characters in the scene, `openquill/locations.md` for setting, `openquill/world_rules.md` for any rules that apply.
