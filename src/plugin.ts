...
export const openQuillServer: Plugin = async (ctx, options) => {
  ...
  const hooks: Hooks = {
    ...
    "experimental.chat.system.transform": async (_input, output) => {
      ...
      output.system.push(
        "Open Quill: Any project file you create or update for this workflow MUST live inside the workspace-root `openquill/` folder. If `openquill/` does not exist yet, create it first. Default project docs therefore live at `openquill/project_brief.md`, `openquill/summary.md`, `openquill/plot.md`, `openquill/style_profile.md`, `openquill/characters.md`, `openquill/locations.md`, `openquill/timeline.md`, `openquill/glossary.md`, `openquill/world_rules.md`, and `openquill/continuity_watchlist.md`. Do NOT create these files in the project root or elsewhere unless the user explicitly requests a different path.",
      )
    },
    ...
    "experimental.session.compacting": async (_input, output) => {
      ...
      output.context.push(
        "Open Quill: You are operating in writing mode. Prefer preserving manuscript language and register. Project docs and canon/memory files belong under `openquill/` at the workspace root; if absent, create that folder first. Standard paths are `openquill/project_brief.md`, `openquill/summary.md`, `openquill/glossary.md`, `openquill/characters.md`, `openquill/locations.md`, `openquill/timeline.md`, `openquill/world_rules.md`, `openquill/style_profile.md`, `openquill/continuity_watchlist.md`, and `openquill/plot.md`.",
      )
    },
  }
